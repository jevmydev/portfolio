...
export const TITLE_CLASS = `font-bold text-9xl text-gray-200 ${GRADIENT_CLASS}`;
export const SUBTITLE_CLASS = "font-bold text-6xl text-gray-200 text-center";

export const INPUT_CLASS = "w-full outline-none py-2 px-4 bg-transparent text-gray-200 border-2 border-gray-400 rounded-md transition-colors focus:bg-gray-400/20";

export const SUBMIT_INPUT_CLASS = `${INTERACTIVE_CLASS} ${INTERACTIVE_ACTIVE_CLASS} py-2 px-4 cursor-pointer`;
