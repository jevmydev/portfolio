export const INTERACTIVE_CLASS = "font-medium flex gap-2 items-center transition rounded hover:bg-slate-400/20 dark:hover:text-slate-200 active:scale-95" as const;
export const INTERACTIVE_ACTIVE_CLASS = "text-primary-blue saturate-200 bg-slate-800 hover:text-slate-200 hover:bg-slate-800 hover:saturate-[4]" as const;

export const GRADIENT_CLASS = "text-transparent bg-clip-text bg-gradient-to-r from-primary-pink to-primary-purple" as const;
...
export const SUBMIT_INPUT_CLASS = `${INTERACTIVE_CLASS} ${INTERACTIVE_ACTIVE_CLASS} py-2 px-4 cursor-pointer justify-center w-full sm:justify-start` as const;
