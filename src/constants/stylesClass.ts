export const INTERACTIVE_CLASS = "flex gap-2 items-center justify-start transition-colors rounded hover:text-slate-800 hover:bg-slate-400/20 dark:hover:text-slate-200" as const;
export const INTERACTIVE_ACTIVE_CLASS = "text-primary-blue filter saturate-200 bg-slate-800 hover:bg-slate-400/20" as const;
...
export const SUBTITLE_CLASS = "font-bold text-center tracking-tight text-3xl text-slate-800 dark:text-slate-200 sm:text-4xl xl:text-6xl" as const;
